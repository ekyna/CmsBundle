...
final class PageEvents
{
    ...
    // Translation
    public const TRANSLATION_INSERT = 'ekyna_cms.page_translation.insert';
    public const TRANSLATION_UPDATE = 'ekyna_cms.page_translation.update';
    public const TRANSLATION_DELETE = 'ekyna_cms.page_translation.delete';
